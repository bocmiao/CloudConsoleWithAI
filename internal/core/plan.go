...
var capabilityRisk = map[string]Risk{
	...
	"dns.record.set":        R2,
	"dns.record.add":        R2,
	"dns.record.modify":     R2,
	"dns.record.delete":     R2,
	"dns.record.status":     R2,
	"cos.bucket.create":     R1,
	"cos.bucket.delete":     R3,
	"cos.acl.set":           R2,
	"cos.referer.set":       R2,
	"cos.cors.set":          R2,
	"cos.lifecycle.set":     R2,
	"cos.versioning.set":    R1,
	"cos.encryption.set":    R1,
	"cos.website.set":       R2,
	"cos.policy.set":        R2,
	"eo.domain.add":         R1,
	"eo.https.set":          R2,
